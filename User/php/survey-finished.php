...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $stmt = $pdoConnect->prepare("INSERT INTO tb_survey_feedback 
                                                (overall_satisfaction, service_rating, service_expectations, like_service, improvement, comments, user_id, ticket_id, taken, date_time) 
                                        VALUES  (:O_S, :S_R, :S_E, :like_service, :improve, :comments, :id, :T_ID, :taken, :D_T )");
            // Bind the blob data
