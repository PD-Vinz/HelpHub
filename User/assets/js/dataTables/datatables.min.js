 ...
 *   https://datatables.net/download/#dt/dt-2.1.6/b-3.1.2/b-colvis-3.1.2/b-html5-3.1.2/date-1.5.3/kt-2.12.1/r-3.0.3/rg-1.5.0/sc-2.4.3/sb-1.8.0/sp-2.3.2
 *
 * Included libraries:
 *   DataTables 2.1.6, Buttons 3.1.2, Column visibility 3.1.2, HTML5 export 3.1.2, DateTime 1.5.3, KeyTable 2.12.1, Responsive 3.0.3, RowGroup 1.5.0, Scroller 2.4.3, SearchBuilder 1.8.0, SearchPanes 2.3.2
 */
      ...
      ((V.ext = C =
        {
          ...
          classes: {},
          builder:
            "dt/dt-2.1.6/b-3.1.2/b-colvis-3.1.2/b-html5-3.1.2/date-1.5.3/kt-2.12.1/r-3.0.3/rg-1.5.0/sc-2.4.3/sb-1.8.0/sp-2.3.2",
          errMode: "alert",
          feature: [],
          features: {},
          search: [],
...
!(function (e) {
  ...
  function D(t, i, e, n, s, o, r) {
    ...
    var a = this,
      i =
        ((this.classes = w.extend(!0, {}, D.classes)),
        (this.c = w.extend(
          !0,
          {},
          D.defaults,
          w.fn.dataTable.ext.searchBuilder,
          i
        )),
        this.c.i18n);
    if (
      ...
      (this.dom = {
        buttons: w("<div/>").addClass(this.classes.buttonContainer),
        condition: w("<select disabled/>")
          .addClass(this.classes.condition)
          .addClass(this.classes.dropDown)
          .addClass(this.classes.italic)
          .attr("autocomplete", "hacking"),
        conditionTitle: w('<option value="" disabled selected hidden/>').html(
        ...
        data: w("<select/>")
          ...
          .addClass(this.classes.dropDown)
          .addClass(this.classes.italic),
        dataTitle: w('<option value="" disabled selected hidden/>').html(
          this.s.dt.i18n("searchBuilder.data", i.data)
        ),
        defaultValue: w("<select disabled/>")
        ...
        delete: w("<button/>")
          ...
          .attr("type", "button"),
        inputCont: w("<div/>").addClass(this.classes.inputCont),
        left: w("<button/>")
  ...
  function m(t, i, e, n, s, o, r) {
    return (
      void 0 === n && (n = 0),
      void 0 === s && (s = !1),
      void 0 === o && (o = 1),
      void 0 === r && (r = void 0),
      (this.classes = a.extend(!0, {}, m.classes)),
      (this.c = a.extend(!0, {}, m.defaults, i)),
      (this.s = {
        criteria: [],
        depth: o,
        dt: t,
  ...
  function f(t, i) {
    (t = new B.Api(t)),
      (i = i || t.init().searchBuilder || B.defaults.searchBuilder);
    return new e(t, i).getNode();
  }
  return (
    (D._escapeHTML = function (t) {
      return t
        .toString()
        .replace(/&lt;/g, "<")
        .replace(/&gt;/g, ">")
    ...
    (D.prototype.doSearch = function () {
      this.c.liveSearch && this.s.dt.draw();
    }),
    (D.parseNumFmt = function (t) {
      return +t.replace(/(?!^-)[^0-9.]/g, "");
    }),
    (D.prototype.updateArrows = function (t) {
      void 0 === t && (t = !1),
        ...
        void 0 !== this.dom.value[0] &&
          w(this.dom.value[0]).trigger("dtsb-inserted");
      for (var i = 1; i < this.dom.value.length; i++)
        this.dom.inputCont.append(this.dom.value[i]),
          w(this.dom.value[i]).trigger("dtsb-inserted");
    ...
    (D.prototype.search = function (t, i) {
    ...
    (D.prototype.getDetails = function (t) {
      void 0 === t && (t = !1);
      var i,
    ...
    (D.prototype.parseNumber = function (t) {
    ...
    (D.prototype.rebuild = function (t) {
      var i,
        e,
        n,
        s = !1;
      if (
        ...
        void 0 !== t.data &&
          ...
          this.dom.data.children("option").each(function () {
            !s &&
            (w(this).text() === t.data ||
              (t.origData && w(this).prop("origData") === t.origData))
              ? (w(this).prop("selected", !0),
                n.removeClass(e),
                (s = !0),
                (i = parseInt(w(this).val(), 10)))
              : w(this).removeProp("selected");
          })),
        s)
      ) {
        (this.s.data = t.data),
    ...
    (D.prototype.setListeners = function () {
      var l = this;
    ...
    (D.prototype.setupButtons = function () {
      550 < u.innerWidth
    ...
    (D.prototype._buildCriteria = function () {
    ...
    (D.prototype._clearCondition = function () {
    ...
    (D.prototype._clearValue = function () {
      var t;
      if (void 0 !== this.s.condition) {
        ...
        if (
          ((this.dom.value = [].concat(
            this.s.conditions[this.s.condition].init(this, D.updateListener)
          )),
          ...
          for (var n = 1; n < this.dom.value.length; n++)
            this.dom.inputCont.append(this.dom.value[n]),
              w(this.dom.value[n]).trigger("dtsb-inserted");
        }
      } else {
    ...
    (D.prototype._getOptions = function () {
      var t = this.s.dt;
      return w.extend(
        !0,
        {},
    ...
    (D.prototype._populateCondition = function () {
      var t = [],
        i = Object.keys(this.s.conditions).length,
        e = this.s.dt,
        n = e.settings()[0].aoColumns,
        s = +this.dom.data.children("option:selected").val();
      if (0 === i) {
        (this.s.type = e.column(s).type()),
          void 0 !== n &&
            (void 0 !== (o = n[s]).searchBuilderType &&
            null !== o.searchBuilderType
              ? (this.s.type = o.searchBuilderType)
              : (void 0 !== this.s.type && null !== this.s.type) ||
                (this.s.type = o.sType)),
          (null !== this.s.type && void 0 !== this.s.type) ||
            (w.fn.dataTable.ext.oApi &&
              w.fn.dataTable.ext.oApi._fnColumnTypes(e.settings()[0]),
            (this.s.type = e.column(s).type())),
          this.dom.condition
            .removeAttr("disabled")
            .empty()
        ...
        var o = e.settings()[0].oLanguage.sDecimal,
          r =
            ("" !== o &&
              this.s.type &&
              this.s.type.indexOf(o) === this.s.type.length - o.length &&
              (this.s.type.includes("num-fmt") ||
                this.s.type.includes("num")) &&
              (this.s.type = this.s.type.replace(o, "")),
            void 0);
        void 0 !== this.c.conditions[this.s.type]
          ? (r = this.c.conditions[this.s.type])
          ...
          ? ((r = this.c.conditions.moment),
            (this.s.dateFormat = this.s.type.replace(/moment-/g, "")))
          : this.s.type && this.s.type.includes("luxon")
          ? ((r = this.c.conditions.luxon),
            (this.s.dateFormat = this.s.type.replace(/luxon-/g, "")))
          : (r = this.c.conditions.string);
        for (var a, d, l = 0, u = Object.keys(r); l < u.length; l++)
          null !== r[(d = u[l])] &&
            (e.page.info().serverSide &&
              r[d].init === D.initSelect &&
              ((a = n[s]),
              this.s.serverData && this.s.serverData[a.data]
                ? ((r[d].init = D.initSelectSSP),
                  (r[d].inputValue = D.inputValueSelect),
                  (r[d].isInputValid = D.isInputValidSelect))
                : ((r[d].init = D.initInput),
                  (r[d].inputValue = D.inputValueInput),
                  (r[d].isInputValid = D.isInputValidInput))),
            (this.s.conditions[d] = r[d]),
            "function" == typeof (V = r[d].conditionName) &&
              (V = V(e, this.c.i18n)),
            t.push(
              w("<option>", { text: V, value: d })
        ...
        this.dom.condition
          ...
          .removeAttr("disabled")
          .addClass(this.classes.italic);
        for (var c = 0, h = Object.keys(this.s.conditions); c < h.length; c++) {
          d = h[c];
          var p = this.s.conditions[d].conditionName,
            m =
              ("function" == typeof p && (p = p(e, this.c.i18n)),
              w("<option>", { text: p, value: d })
                .addClass(this.classes.option)
                .addClass(this.classes.notItalic));
      ...
      for (var f = 0, g = t; f < g.length; f++) this.dom.condition.append(g[f]);
      if (n[s].searchBuilder && n[s].searchBuilder.defaultCondition) {
        var v = n[s].searchBuilder.defaultCondition;
        if ("number" == typeof v)
          this.dom.condition.prop("selectedIndex", v),
            this.dom.condition.trigger("change");
        else if ("string" == typeof v)
          for (var b = 0; b < t.length; b++)
            for (
              var y = 0, C = Object.keys(this.s.conditions);
              y < C.length;
              y++
            ) {
              var V,
                I = C[y];
              if (
                ("string" == typeof (V = this.s.conditions[I].conditionName)
                  ? V
                  : V(e, this.c.i18n)) === t[b].text() &&
                I === v
              ) {
                this.dom.condition
                  .prop(
                    "selectedIndex",
                    this.dom.condition.children().toArray().indexOf(t[b][0])
                  )
    ...
    (D.prototype._populateData = function () {
      ...
      for (var e, n, s = 0; s < t.length; s++)
        (!0 !== this.c.columns && !i.includes(s)) ||
          ...
          this.dom.data.append(
            w("<option>", { text: n.text, value: n.index })
              .addClass(this.classes.option)
              .addClass(this.classes.notItalic)
    ...
    (D.prototype._populateValue = function (i) {
      for (
        var t,
          e = this,
          n = this.s.filled,
      ...
      if (1 < r.length) for (t = 0; t < r.length; t++) w(r[t]).remove();
      for (
        void 0 !== i &&
    ...
    (D.prototype._throttle = function (n, s) {
      var o = null,
        r = null,
        a = this;
      return (
      ...
      for (
        var s = e.dom.data.children("option:selected").val(),
          ...
          a =
            ...
            w("<select/>")
              .addClass(D.classes.value)
              .addClass(D.classes.dropDown)
              .addClass(D.classes.italic)
              .addClass(D.classes.select)
              .append(e.dom.valueTitle)
              .on("change.dtsb", function () {
                w(this).removeClass(D.classes.italic), t(e, this);
              })),
          d = (e.c.greyscale && a.addClass(D.classes.greyscale), []),
          l = [],
          u = 0,
          c = o;
        u < c.length;
          ...
          f =
            ...
            function (t, i) {
              ...
              -1 === d.indexOf(i) &&
                ...
                t.val() === n[0] &&
                (t.prop("selected", !0),
                a.removeClass(D.classes.italic),
    ...
    (D.initSelectSSP = function (t, i, e) {
      ...
      for (
        var n = w("<select/>")
            ...
            .on("change.dtsb", function () {
              w(this).removeClass(D.classes.italic), i(t, this);
            }),
          s = (t.c.greyscale && n.addClass(D.classes.greyscale), []),
          o = 0,
        ...
        t.s.type.includes("html") &&
          ...
          null !== e &&
            d.val() === e[0] &&
            (d.prop("selected", !0),
            n.removeClass(D.classes.italic),
            t.dom.valueTitle.removeProp("selected"));
      }
      for (var l = 0, u = s; l < u.length; l++) n.append(u[l]);
      return n;
    }),
    (D.initSelectArray = function (t, i, e) {
      return D.initSelect(t, i, (e = void 0 === e ? null : e), !0);
    }),
    (D.initInput = function (i, e, t) {
      void 0 === t && (t = null);
      var n = i.s.dt.settings()[0].searchDelay,
        n = w("<input/>")
          .addClass(D.classes.value)
          .addClass(D.classes.input)
          .on(
      ...
      return (
        i.c.greyscale && n.addClass(D.classes.greyscale),
        null !== t && n.val(t[0]),
    ...
    (D.init2Input = function (i, e, t) {
      ...
      return (
        i.c.greyscale &&
          (n[0].addClass(D.classes.greyscale),
          n[2].addClass(D.classes.greyscale)),
    ...
    (D.initDate = function (e, n, t) {
      ...
      return (
        e.c.greyscale && i.addClass(D.classes.greyscale),
        null !== t && i.val(t[0]),
    ...
    (D.init2Date = function (e, n, t) {
      ...
      return (
        e.c.greyscale &&
          (o[0].addClass(D.classes.greyscale),
          o[2].addClass(D.classes.greyscale)),
    ...
    (D.isInputValidInput = function (t) {
      for (var i = !0, e = 0, n = t; e < n.length; e++) {
        var s = n[e];
    ...
    (D.inputValueSelect = function (t) {
      for (var i = [], e = 0, n = t; e < n.length; e++) {
        var s = n[e];
        s.is("select") &&
          i.push(D._escapeHTML(s.children("option:selected").data("sbv")));
      }
      return i;
    }),
    (D.inputValueInput = function (t) {
      for (var i = [], e = 0, n = t; e < n.length; e++) {
        var s = n[e];
        s.is("input") && i.push(D._escapeHTML(s.val()));
      }
      return i;
    }),
    (D.updateListener = function (t, i, e) {
    ...
    (D.dateConditions = {
      "=": {
        ...
        init: D.initDate,
        inputValue: D.inputValueInput,
        isInputValid: D.isInputValidInput,
        search: function (t, i) {
    ...
    (D.numConditions = {
      "=": {
        ...
        init: D.initSelect,
        inputValue: D.inputValueSelect,
        isInputValid: D.isInputValidSelect,
        search: function (t, i) {
          return +t == +i[0];
        },
      },
    ...
    (D.defaults = {
      ...
      conditions: {
        ...
        date: D.dateConditions,
        html: D.stringConditions,
        "html-num": D.numConditions,
        "html-num-fmt": D.numFmtConditions,
        luxon: D.luxonDateConditions,
        moment: D.momentDateConditions,
        num: D.numConditions,
        "num-fmt": D.numFmtConditions,
        string: D.stringConditions,
      },
      depthLimit: !1,
      enterSearch: !1,
    ...
    (m.prototype.getDetails = function (t) {
    ...
    (m.prototype.rebuild = function (t) {
      var i;
      if (
        !(
          void 0 === t.criteria ||
      ...
      if (!this.s.preventRedraw) {
        ...
        for (var t = 0; t < this.s.criteria.length; t++) {
          ...
          i instanceof d
            ...
            : i instanceof m && 0 < i.s.criteria.length
            ? ((this.s.criteria[t].index = t),
              (this.s.criteria[t].criteria.s.index = t),
              this.s.criteria[t].criteria.dom.container.insertBefore(
                this.dom.add
    ...
    (m.prototype.redrawLogic = function () {
      for (var t = 0, i = this.s.criteria; t < i.length; t++) {
        var e = i[t];
        e.criteria instanceof m && e.criteria.redrawLogic();
      }
      this.setupLogic();
    }),
    (m.prototype.search = function (t, i) {
      return "AND" === this.s.logic
        ? this._andSearch(t, i)
        : "OR" !== this.s.logic || this._orSearch(t, i);
    }),
    (m.prototype.setupLogic = function () {
      if (
        ...
        for (var t = 0, i = this.s.criteria; t < i.length; t++) {
          var e = i[t];
          e.criteria instanceof d && e.criteria.setupButtons();
        }
    ...
    (m.prototype.addCriteria = function (t) {
      for (
        var i =
      ...
      for (var o = 0, r = this.s.criteria; o < r.length; o++) {
        var a = r[o];
        a.criteria instanceof d &&
          a.criteria.updateArrows(1 < this.s.criteria.length);
      }
      this._setCriteriaListeners(e), e.setListeners(), this.setupLogic();
    }),
    (m.prototype.checkFilled = function () {
      for (var t = 0, i = this.s.criteria; t < i.length; t++) {
        var e = i[t];
        if (
          (e.criteria instanceof d && e.criteria.s.filled) ||
          (e.criteria instanceof m && e.criteria.checkFilled())
        )
          return !0;
      }
      return !1;
    ...
    (m.prototype.count = function () {
      for (var t = 0, i = 0, e = this.s.criteria; i < e.length; i++) {
        var n = e[i];
        n.criteria instanceof m ? (t += n.criteria.count()) : t++;
      }
      return t;
    }),
    (m.prototype._addPrevGroup = function (t) {
    ...
    (m.prototype._addPrevCriteria = function (t) {
      var i = this.s.criteria.length,
        e = new d(
          this.s.dt,
          this.s.opts,
    ...
    (m.prototype._andSearch = function (t, i) {
      if (0 !== this.s.criteria.length)
        for (var e = 0, n = this.s.criteria; e < n.length; e++) {
          var s = n[e];
          if (
            (!(s.criteria instanceof d) || s.criteria.s.filled) &&
    ...
    (m.prototype._removeCriteria = function (t, i) {
      if (
        (void 0 === i && (i = !1),
        ...
        for (var e = void 0, n = 0; n < this.s.criteria.length; n++)
          this.s.criteria[n].index === t.s.index &&
            (!i || this.s.criteria[n].criteria instanceof m) &&
            (e = n);
        for (
    ...
    (m.prototype._setCriteriaListeners = function (n) {
      var s = this;
    ...
    (m.prototype._setGroupListeners = function (i) {
      var e = this;
    ...
    (m.prototype._setLogicListener = function () {
      var e = this;
    ...
    (m.prototype._toggleLogic = function () {
      "OR" === this.s.logic
        ? ((this.s.logic = "AND"),
          this.dom.logic
            .children()
    ...
    (n.prototype._setUp = function (t) {
      ...
      if (
        ...
        (void 0 === i || i.includes(void 0) || i.includes(null)) &&
          (l.fn.dataTable.ext.oApi &&
            l.fn.dataTable.ext.oApi._fnColumnTypes(this.s.dt.settings()[0]),
    ...
    (n.prototype._build = function () {
      ...
      l.fn.dataTable.ext.search.includes(this.s.search) ||
        ...
        this.s.dt.on("destroy.dtsb", function () {
          ...
          for (
            var t = l.fn.dataTable.ext.search.indexOf(n.s.search);
            -1 !== t;

          )
            l.fn.dataTable.ext.search.splice(t, 1),
              (t = l.fn.dataTable.ext.search.indexOf(n.s.search));
          n.s.dt.off(".dtsb"), l(n.s.dt.table().node()).off(".dtsb");
        });
    }),
    ...
    (i.Criteria = d),
    (i = B.Api.register),
    (B.ext.searchBuilder = { conditions: {} }),
    ...
    s(t).on("preInit.dt.dtsp", function (t, i) {
      "dt" !== t.namespace ||
        (!i.oInit.searchBuilder && !B.defaults.searchBuilder) ||
        i._searchBuilder ||
        f(i);
    }),
    B.ext.feature.push({ cFeature: "Q", fnInit: f }),
    B.feature && B.feature.register("searchBuilder", f),
    B
  );
});
...
!(function (n) {
  ...
  "function" == typeof define && define.amd
    ? define(
        ["jquery", "datatables.net-dt", "datatables.net-searchbuilder"],
        function (e) {
          return n(e, window, document);
        }
      )
...
!(function (e) {
  ...
  function B(t, s, e, a, i) {
    ...
    if (l.select)
      return (
        ...
        (s = ""),
        this.s.colExists
          ? ((s = _(this.s.dt.column(this.s.index).header()).text()),
            this.dom.dtP.find("th").eq(0).text(s))
          : ((s = this.s.customPaneSettings.header || "Custom Pane"),
            this.dom.dtP.find("th").eq(0).html(s)),
        this.s.colOpts.name
  ...
  return (
        ...
        for (var i = 0, n = t; i < n.length; i++) {
          ...
          if ("function" == typeof o.value) {
            for (var d = 0; d < e.length; d++)
              o.value.call(this.s.dt, e[d], s[0][d]) && l.total++;
    ...
    (B.prototype._populatePaneArray = function (t, s, a, e) {
      ...
      "string" == typeof this.s.colOpts.orthogonal
        ...
        : ("string" ==
            typeof (i =
              null ===
              (i = n(t, this.s.index, this.s.colOpts.orthogonal.search))
                ? ""
                : i) && (i = i.replace(/<[^>]*>/g, "")),
          this.s.rowData.filterMap.set(t, i),
          e[i]
    ...
    (s.prototype.updateRows = function () {
      ...
      for (
        var a = this, i = 0, n = this.s.dtPane.rows().data().toArray();
        i < n.length;
        i++
      )
        !(function (e) {
    ...
    (k.prototype.clearSelections = function () {
      ...
      for (var a = [], i = 0, n = this.s.panes; i < n.length; i++)
        (t = n[i]).s.dtPane && a.push(t.clearPane());
      return a;
    }),
        ...
        for (var r = 0, l = this.s.selectionList; r < l.length; r++) {
          ...
          if (h.s.dtPane) {
            ...
            if (((h.s.selections = d.rows), 0 !== d.rows.length)) {
              this.s.dt.draw();
              for (
                var b = 0, _ = 0, C = 0, S = 0, O = this.s.panes;
                S < O.length;
                S++
              )
                (t = O[S]).s.dtPane &&
          ...
          : (this.processing(!0),
            setTimeout(function () {
              N(s, e, a),
                ...
                a._panes.rebuild(void 0, !0),
                o("table.dataTable", a._panes.getNode())
                  .DataTable()
                  .columns.adjust(),
                n.processing(!1);
            }, 10));
...
!(function (t) {
  ...
  "function" == typeof define && define.amd
    ? define(
        ["jquery", "datatables.net-dt", "datatables.net-searchpanes"],
        function (e) {
          return t(e, window, document);
        }
      )
      ...
      (d = function (e, n) {
        n.fn.dataTable || require("datatables.net-dt")(e, n),
          n.fn.dataTable.SearchPanes ||
            require("datatables.net-searchpanes")(e, n);
      }),
      "undefined" == typeof window
        ? (module.exports = function (e, n) {
            return (
              (e = e || window), (n = n || a(e)), d(e, n), t(n, 0, e.document)
            );
          })
        : (d(window, a), (module.exports = t(a, window, window.document))))
    : t(jQuery, window, document);
})(function (e, n, t) {
  "use strict";
  return e.fn.dataTable;
