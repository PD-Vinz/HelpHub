...
<body>
	...
	<div class="panel-body">
		<div class="container-fluid col-md-12">
			<div id="msg"></div>
<form method="post" action="action\update-single-userS.php" id="manage-user" enctype="multipart/form-data" onsubmit="return validateForm();">
            <div class="container-fluid col-md-6">
                ...
                <div class="form-group col-6">
					...
					<input type="email" name="email" id="emailadd" class="form-control" value="<?php echo $FetchEmail?>" required placeholder="DHVSU Email" oninput="validateEmail()">
                ...
                <div class="form-group col-6">
					...
					<input type="date" name="birthday" id="bdayInput" class="form-control" value="<?php echo $FetchBirthday?>" required>
				</div>
<script>
    ...
    bdayInput.max = maxDate.toISOString().split("T")[0];
                ...
                <div class="form-group col-6">
					...
					<input type="text" name="year_section" id="year_section" class="form-control" value="<?php echo $FetchYearSection?>" required maxlength="5">
				</div>
                <div class="form-group col-6">
					<label for="altemail">Alternative Email Address</label>
					<input type="email" name="altemail" id="altemail" class="form-control" value="<?php echo $FetchAltEmail?>" placeholder="Personal Email">
				</div>
