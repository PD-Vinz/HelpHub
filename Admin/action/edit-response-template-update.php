...
try {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $stmt = $pdoConnect->prepare("UPDATE templates SET template_name = :tn, template_content=:tc WHERE template_id = :id");
            // Bind the blob data
            $stmt->bindParam(':id', $ID, PDO::PARAM_STR);
            $stmt->bindParam(':tn', $TN, PDO::PARAM_STR);
    ...
    echo "<a onclick='history.back()'>Back</a>";
