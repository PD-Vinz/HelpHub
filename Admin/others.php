...
<body>
    ...
    <button class="btn btn-flat btn-primary" id="saveButton">Save Changes</button>
    ...
    <script>
        ...
        window.onload = function() {
            loadFile('admin-system-configuration/position.txt', 'fileContent1');
            loadFile('admin-system-configuration/usertype.txt', 'fileContent2');
        };
