...
<l?php $currentFile=basename($_SERVER['PHP_SELF']); ?>
            ...
            <ul class="nav" id="main-menu">
                ...
                <li class="text-center">
                    <div class="text-center"><br>
                        <a href="profile.php"><img src="data:image/jpeg;base64,<?php echo $P_PBase64 ?>"
                                class="user-image img-responsive" alt="avatar"></a>
                ...
                <li>
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"
                        onclick="handleTicketDropdownToggle(event)">
                        <i class="number fa-solid fa-graduation-cap fa-xl"></i> Student Tickets <span
                            class="fa arrow"></span>
                    </a>


                    <ul class="nav nav-second-level ticket-dropdown-menu <?= $studentDropdownOpen ? 'in' : '' ?>">
                        <!-- Keep open if active -->
                        <li>
                            <a class="<?= ($currentFile == 'ticketdash.php' && $_GET['id'] == 1) ? 'active-menu' : '' ?>"
                                href="ticketdash.php?id=1">
                                &nbsp;&nbsp;<i class="fa fa-ticket fa-xl" aria-hidden="true"></i>All Tickets
                            </a>
                        </li>
                        <li>
                            <a class="<?= ($currentFile == 'ticket-pending.php' && $_GET['id'] == 1) ? 'active-menu' : '' ?>"
                                href="ticket-pending.php?id=1">
                                &nbsp;&nbsp;<i class="fa fa-hourglass-half fa-xl" aria-hidden="true"></i>Pending Tickets
                            </a>
                        </li>
                        <li>
                            <a class="<?= ($currentFile == 'ticket-opened.php' && $_GET['id'] == 1) ? 'active-menu' : '' ?>"
                                href="ticket-opened.php?id=1">
                                &nbsp;&nbsp;<i class="fa fa-envelope-open fa-xl" aria-hidden="true"></i>Opened Tickets
                            </a>
                        </li>
                        <li>
                            <a class="<?= ($currentFile == 'ticket-closed.php' && $_GET['id'] == 1) ? 'active-menu' : '' ?>"
                                href="ticket-closed.php?id=1">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level ticket-dropdown-menu <?= $employeeDropdownOpen ? 'in' : '' ?>">
                        <!-- Keep open if active -->
                        <li>
                            <a class="<?= ($currentFile == 'ticketdash.php' && $_GET['id'] == 2) ? 'active-menu' : '' ?>"
                                href="ticketdash.php?id=2">
                                &nbsp;&nbsp;<i class="fa fa-ticket fa-xl" aria-hidden="true"></i>All Tickets
                            </a>
                        </li>
                        <li>
                            <a class="<?= ($currentFile == 'ticket-pending.php' && $_GET['id'] == 2) ? 'active-menu' : '' ?>"
                                href="ticket-pending.php?id=2">
                                &nbsp;&nbsp;<i class="fa fa-hourglass-half fa-xl" aria-hidden="true"></i>Pending Tickets
                            </a>
                        </li>
                        <li>
                            <a class="<?= ($currentFile == 'ticket-opened.php' && $_GET['id'] == 2) ? 'active-menu' : '' ?>"
                                href="ticket-opened.php?id=2">
                                &nbsp;&nbsp;<i class="fa fa-envelope-open fa-xl" aria-hidden="true"></i>Opened Tickets
                            </a>
                        </li>
                        <li>
                            <a class="<?= ($currentFile == 'ticket-closed.php' && $_GET['id'] == 2) ? 'active-menu' : '' ?>"
                                href="ticket-closed.php?id=2">
                                &nbsp;&nbsp;<i class="fa-solid fa-check-to-slot fa-xl"></i>Closed Tickets
                            </a>
                        </li>
                ...
                <?php if (isset($U_T) && $U_T === 'Administrator'): ?>
                    <li>
                        <a class="<?= ($currentFile == 'feedback-analysis.php') ? 'active-menu' : '' ?>"
                            href="feedback-analysis.php">
                ...
                <i class="fa-regular fa-comment-dots fa-xl"></i> Employee Reports
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level ticket-dropdown-menu <?= $userListDropdownOpen ? 'in' : '' ?>">
                            ...
                            <li>
                                <a class="<?= ($currentFile == 'user-student-list.php') ? 'active-menu' : '' ?>"
                                    href="user-student-list.php">
                                    &nbsp;&nbsp;<i class="fa-solid fa-graduation-cap fa-xl" aria-hidden="true"></i>
                                    Student's Accounts
                                </a>
                            </li>
                            <li>
                                <a class="<?= ($currentFile == 'user-employee-list.php') ? 'active-menu' : '' ?>"
                                    href="user-employee-list.php">
                                    &nbsp;&nbsp;<i class="fa-solid fa-briefcase fa-xl" aria-hidden="true"></i> Employee's
                                    Account
                                </a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level ticket-dropdown-menu <?= $systemDocsDropdownOpen ? 'in' : '' ?>">
                            ...
                            <li>
                                <a class="<?= $currentFile == 'response-templates.php' ? 'active-menu' : '' ?>"
                                    href="response-templates.php">
                                    &nbsp;&nbsp;<i class="fa fa-comment-dots"></i> Response Templates
                                </a>
                            </li>
                            <li>
                                <a class="<?= $currentFile == 'information-templates.php' ? 'active-menu' : '' ?>"
                                    href="information-templates.php">
                    ...
                    <li>
                        ...
                        <ul
                            class="nav nav-second-level ticket-dropdown-menu <?= $systemSettingsDropdownOpen ? 'in' : '' ?>">
                            ...
                            <li>
                                <a class="<?= ($currentFile == 'mailer-configuration.php') ? 'active-menu' : '' ?>"
                                    href="mailer-configuration.php">
